...
def log_hardware_info():
    ...
    logger.info(f"System CPUs: {psutil.cpu_count(logical=True)}")
...
def main():
    try:
        ...
        logger.info("Loading Stable Diffusion pipeline for CPU...")
        ...
        # Image generation
        logger.info("Generating image (steps=10, size=384x384)...")
        gen_start = time.time()
